...
export const STRINGS = {
	...
	homeInfo1: {
		...
		imageAlt:
			'Retro 8-bit isometric view of an art community in a gallery with a lot of paintings and a trophy in the middle'
	},
	homeInfo2: {
		title: 'Transform your daily steps into art',
		...
		imageAlt:
			'Retro 8-bit image of a man in a suit pointing at a ven diagram reading ‘people who like step counting apps + people who like art = people who’ll love Art Collector’'
	},
	homeInfo3: {
	...
	testimonials: [
		{
			headline: 'Great Motivator',
			body: "This app is a great motivator to get your steps in for the day, u can collect amazing art work just for doing a daily walk ... I've learned about so many amazing artists",
			username: 'dj044055',
		...
		{
			headline: 'Best App',
			body: 'Art Collector has helped me get my step count up while I enjoy and learn about cool art - really fun, cute way app, big recommend',
			username: 'Svhsjsix',
			source: 'App Store Review',
			showStars: true
		},
		{
			headline: 'Good wholesome fun art app',
			body: "I like that I don't have to do a lot, it just ticks away in the background presenting me with new art.",
			username: 'coldchristmas',
			source: 'App Store Review',
			showStars: true
		}
	]
